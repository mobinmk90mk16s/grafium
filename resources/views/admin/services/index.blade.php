                        ...
                        <tr data-type="{{ $service->type }}" data-status="{{ $service->status }}" data-search="{{ $service->title }} {{ $service->place }}">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('admin.services.edit', $service->id) }}" class="text-blue-400 hover:text-blue-300 transition">
                                        <i data-lucide="pencil" class="w-4 h-4"></i>
                                    </a>
                                    <button onclick="toggleStatus({{ $service->id }})" class="{{ $service->status === 'active' ? 'text-amber-400 hover:text-amber-300' : 'text-emerald-400 hover:text-emerald-300' }} transition">
