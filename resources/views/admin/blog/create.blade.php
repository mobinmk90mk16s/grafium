...
<head>
    ...
    <title>افزودن پست جدید | GRAFIUM</title>
        ...
        <nav class="space-y-5">
            <div>
                ...
                <ul class="space-y-0.5">
                    ...
                    <li>
                        <a href="{{ route('admin.blog.create') }}" class="menu-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#94a3b8] text-sm font-medium transition">
        ...
        <div class="flex flex-wrap justify-between items-center pb-4 border-b border-[#1a2f4a] mb-6">
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-2xl font-extrabold text-white">افزودن پست جدید</h1>
                </div>
                <p class="text-sm text-[#475569] mt-0.5 mr-9">ایجاد یک پست جدید برای بلاگ</p>
            </div>
            ...
            <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div class="form-group lg:col-span-2">
                        ...
                        <input type="text" name="title" class="input-dark" placeholder="عنوان پست را وارد کنید..." required />
                    </div>

                    <div class="form-group">
                        <label>لینک یکتا (اسلاگ)</label>
                        <input type="text" name="slug" class="input-dark" placeholder="خالی بگذارید تا خودکار تولید شود" />
                    </div>
                    ...
                    <div class="form-group lg:col-span-2">
                        ...
                        <textarea name="summary" class="input-dark" rows="2" placeholder="خلاصه پست (برای نمایش در لیست)"></textarea>
                    </div>

                    <div class="form-group lg:col-span-2">
                        <label>متن کامل پست</label>
                        <textarea name="text" class="input-dark" rows="10" placeholder="متن کامل پست را وارد کنید..." required></textarea>
                    </div>

                    <div class="form-group">
                        <label>تگ‌ها (با کاما جدا کنید)</label>
                        <input type="text" name="tags" class="input-dark" placeholder="مثال: لاراول, PHP, آموزش" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="published_at" class="input-dark" />
                    </div>

                    <div class="form-group lg:col-span-2">
                        <label>عنوان سئو (Meta Title)</label>
                        <input type="text" name="meta_title" class="input-dark" placeholder="عنوان سئو" />
                    </div>

                    <div class="form-group lg:col-span-2">
                        <label>توضیحات سئو (Meta Description)</label>
                        <textarea name="meta_description" class="input-dark" rows="2" placeholder="توضیحات سئو"></textarea>
                    </div>
                </div>

                <div class="flex gap-3 mt-4 pt-4 border-t border-[#1a2f4a]">
                    <button type="submit" class="btn-emerald">
                        <i data-lucide="save" class="w-4 h-4"></i> ذخیره پست
                    </button>
